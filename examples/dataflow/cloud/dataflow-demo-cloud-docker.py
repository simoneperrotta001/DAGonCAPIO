...
if __name__ == '__main__':
    ...
    keysshparams = {"option": KeyOptions.GET, "keyname": "test-key", "keypath": "test-key.pem",
                    "cloudargs": {"name": "test-key"}}
    keysDO = KeyPair.generate_RSA()

    googleKeyParams = {"keypath": "googlekey.pem", "username": "dagon", "public_key": keysDO[1],
                       "private_key": keysDO[0]}

    keysshparams3 = {"option": KeyOptions.GET, "keyname": "dagonkey", "keypath": "dagonkey.pem",
    ...
    taskB = CloudTask("B", "echo I am B > f2.txt; cat workflow://A/output/f1.txt >> f2.txt", Provider.EC2, "ubuntu",
                      create_instance=False, id="i-03d1c4f2b326ed016", keyparams=keysshparams3, flavour=defaultflavour,
                      instance_name="B")

    # The task C: a Docker local container
    taskC = DockerTask("C",
                       "mkdir output;ls > output/f4.txt;echo I am C > f3.txt; cat workflow://A/output/f1.txt >> f3.txt",
                       image="ubuntu:18.04")

    # Task D: another EC2 instance
    taskD = CloudTask("D", "echo I am D > f1.txt", Provider.EC2, "ubuntu", create_instance=False,
                      id="i-021d09715bc0b877c", keyparams=keysshparams3,
                      endpoint="6c24aea0-e208-11e8-8c92-0a1d4c5c824a", flavour=defaultflavour, instance_name="dagon")

    # Task E: Another EC2 instance
    taskE = CloudTask("E", "echo I am E > f4.txt; cat workflow://D/f1.txt >> f4.txt; cat workflow://C/f3.txt >> f4.txt",
                      Provider.EC2, "ubuntu", create_instance=False, id="i-021d09715bc0b877c", keyparams=keysshparams3,
                      endpoint="6c24aea0-e208-11e8-8c92-0a1d4c5c824a", flavour=defaultflavour, instance_name="dagon")

    # The task F: a Docker local container
    taskF = DockerTask("F",
                       "echo I am F > f7.txt; cat workflow://C/f3.txt >> f7.txt; cat workflow://C/output/f4.txt >> "
