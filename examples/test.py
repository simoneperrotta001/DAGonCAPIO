...
if __name__ == '__main__':
  ...
  taskA= CloudTask("A", "mkdir output;echo I am A > output/f1.txt", Provider.EC2,"dagon",create_instance=False,id="i-021d09715bc0b877c", endpoint="6c24aea0-e208-11e8-8c92-0a1d4c5c824a",flavour=defaultflavour, instance_name="dagon")

  # The task B: another EC2 instance
  taskB= CloudTask("B", "echo I am B > f2.txt; cat workflow://A/output/f1.txt >> f2.txt", Provider.EC2,"dagon",create_instance=False,id="i-021d09715bc0b877c",flavour=defaultflavour, instance_name="B")
